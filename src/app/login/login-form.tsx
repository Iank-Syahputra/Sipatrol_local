...
export default function LoginForm() {
  ...
  const theme = {
    ...
    primaryBg: isOfficer ? "bg-[#00F7FF]" : "bg-[#F59E0B]",
    primaryText: isOfficer ? "text-slate-900" : "text-white",
    ...
    overlay: isOfficer ? "bg-cyan-900/20" : "bg-amber-900/20",
    icon: isOfficer ? Shield : Zap,
